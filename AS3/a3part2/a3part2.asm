...
blink_loop:
	...
	ldi r17, 14 ; <- TODO: change the column
	push r16
	push r17
	rcall lcd_gotoxy
	pop r17
	...
	;figure out the (row, column) of '>' and make a change
	ldi r16, 0 ; <- TODO: change the row
	ldi r17, 15; <- TODO: change the column
	push r16
	push r17
	rcall lcd_gotoxy
	pop r17
...
;======================================================
	;Part2
	;figure out the (row, column) of '0' and make a change
	ldi r16, 1 ; <- TODO: change the row
	ldi r17, 11; <- TODO: change the column
	push r16
	push r17
	rcall lcd_gotoxy
	pop r17
...
compare_r17:
	...
	;cpi r17, 0x01 ;========================TEST CODE FOR AUTO ADDING=======================	
	breq addNumber
	rjmp jamp
